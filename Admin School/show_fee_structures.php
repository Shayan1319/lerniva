...
<head>
    <title>Fee Structures (AJAX)</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
</head>

<body class="p-4">
    <h2>All Fee Structures (AJAX)</h2>
                ...
                <div class="modal-body">
                    ...
                    <form id="updateFeeStructureForm">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="update_frequency" name="frequency" required>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group mb-2">
                                <select class="form-select" id="update_fee_type_id">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="update_total_amount" name="total_amount"
                                readonly>
                        </div>
    ...
    <!-- ✅ This is the ONLY updated JS part -->
    <script>
