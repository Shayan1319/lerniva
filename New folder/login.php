...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        $stmt = $conn->prepare("SELECT id, school_name, admin_contact_person,
password FROM schools WHERE school_email = ?"); 
...
else { $message = "Invalid password."; $message_type ='danger'; }
 } else 
...
<body>
    <div class="login-container">
        ...
        <div class="right-section">
            <img src="assets/img/Final Logo.jpg" alt="Logo" style="width: 400px; max-width: 100%; height: auto" />
        </div>
    </div>
