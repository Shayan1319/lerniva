...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <ul class="nav nav-pills justify-content-center mb-4" id="registrationTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="parent-tab" data-bs-toggle="pill" data-bs-target="#parent" type="button"
                    role="tab" aria-controls="parent" aria-selected="false">
                    Parent Registration
                </button>
            </li>
        </ul>
                    ...
                    <div class="card-body">
                        <form id="schoolForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="username" pattern="[A-Za-z]{8}"
                    ...
                    <div class="card-body">
                        <form id="studentForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="parent_cnic" pattern="[0-9]{13}"
                ...
                <div class="card shadow-sm rounded-4 mb-4">
                    <div class="card-body">
                        <form id="parentForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label class="form-label">Parent CNIC</label>
                                <input type="text" class="form-control" name="parent_cnic" pattern="[0-9]{12,15}"
