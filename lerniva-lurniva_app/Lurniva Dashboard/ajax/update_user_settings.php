...
$admin_id = $_SESSION['app_admin_id'];
...
$check_sql = "SELECT id FROM school_settings WHERE person = 'app_admin' AND person_id = ?";
...
if ($check_stmt->num_rows > 0) {
    ...
    $sql = "UPDATE school_settings SET " . implode(", ", $fields) . " WHERE person = 'app_admin' AND person_id = ?";
    $params[] = $admin_id;
    $types .= "i";
    ...
    $insert_params = ["app_admin", $admin_id];
    $insert_types = "si";
